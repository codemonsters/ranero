...
public class GameScreen implements Screen, InputProcessor {
    ...
    private TextureRegion cocheTexture1;
    ...
    public GameScreen(final Ranero game){
        ...
        cocheTexture1 = new TextureRegion(raneroSpriteSheet, 13, 337, 16, 14);
        ...
        coche1 = new Coche(cocheTexture1);
        coche1.setPosition(110, 260);
